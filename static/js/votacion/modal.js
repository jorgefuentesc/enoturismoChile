        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (link_instagram != ''){
                    contenedor_logos.innerHTML+= 
                    `
                    <a style="z-index:9000;" id="direccion-instagram" onclick=fn_redirect() href="https://www.facebook.com/centroturisticocoopcapel?mibextid=LQQJ4d"><img src="https://premiosenoturismochile.cl/wp-content/uploads/2023/08/insta.png" alt=""></a>
                    `
                }
                if (link_facebook != ''){
                    contenedor_logos.innerHTML+= 
